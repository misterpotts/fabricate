import {CombinableString, CraftingComponent} from "../../src/scripts/common/CraftingComponent";
...
const testComponentOne: CraftingComponent = new CraftingComponent({
    id:"iyeUGBbSts0ij92X",
    essences: Combination.ofUnits([new Unit(new CombinableString(elementalEarth.id), 2)]),
...
const testComponentTwo: CraftingComponent = new CraftingComponent({
    id:"Ie7NoXMja9wI6xya",
    essences: Combination.ofUnits([new Unit(new CombinableString(elementalFire.id), 2)]),
...
const testComponentThree: CraftingComponent = new CraftingComponent({
    id:"tdyV4AWuTMkXbepw",
    essences: Combination.ofUnits([new Unit(new CombinableString(elementalWater.id), 2)]),
...
const testComponentFour: CraftingComponent = new CraftingComponent({
    id:"Ra2Z1ujre76weR0i",
    essences: Combination.ofUnits([new Unit(new CombinableString(elementalAir.id), 2)]),
    name: "Test Component Four",
    imageUrl: Properties.ui.defaults.itemImageUrl,
    salvage: Combination.of(new CombinableString(testComponentThree.id), 2)
});
...
const testComponentFive: CraftingComponent = new CraftingComponent({
    ...
    salvage: Combination.ofUnits([
        new Unit(new CombinableString(testComponentOne.id), 2),
