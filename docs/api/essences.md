...
Once you've [created a crafting system](/fabricate/api/systems#create-a-crafting-system), you can create essences for it by calling `game.fabricate.api.essences.create()` and passing in the essence details.
