...
import {CraftingSystemSpec} from "./system/specification/CraftingSystemSpec";
...
async function loadCraftingSystems(): Promise<void> {
    ...
    const systemNames = systemSpecifications.map((systemSpec: CraftingSystemSpec) => systemSpec.name);
 ...
 * */
async function loadCraftingSystem(systemSpec: CraftingSystemSpec): Promise<void> {
