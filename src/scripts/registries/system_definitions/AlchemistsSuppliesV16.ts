...
const prone = new Condition5e(['water', 'water'],
    'Release a puddle of slippery oil. Affected targets immediately fall prone. ');

const lightningDamage = new Damage5e(['air', 'air'],
...
const alchemySpecification = new AlchemySpecification(essenceCombiner, CraftingComponent.builder()
...
const AlchemistsSuppliesSystemSpec: CraftingSystemSpecification = CraftingSystemSpecification.builder()
    ...
    .withEssence(new EssenceDefinition('Negative Energy', 'Negative Energy - The essence of death and destruction', 'moon'))
    .build();
