...
# Run dry-run
if OUTPUT=$(npx semantic-release --dry-run --no-ci --branches "main" --plugins "@semantic-release/commit-analyzer, @semantic-release/release-notes-generator, @semantic-release/changelog" 2>&1); then
